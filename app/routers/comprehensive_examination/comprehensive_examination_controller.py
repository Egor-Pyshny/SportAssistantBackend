...
from routers.comprehensive_examination.comprehensive_examination_service import ComprehensiveExaminationService
...
from schemas.comprehensive_examination.comprehensive_examination_schema import ComprehensiveExaminationSchema
...
from schemas.comprehensive_examination.comprehensive_examination_view_schema import ComprehensiveExaminationViewSchema
...
async def create_comprehensive_exam_result(
    ...
    comprehensive_exams_service: ComprehensiveExaminationService = Depends(ComprehensiveExaminationService),
):
    response.set_cookie("sid", sid, httponly=True)
    await comprehensive_exams_service.create(body, sid)


@comprehensive_exams_router.get(path=Urls.comprehensive_examination_list.value, response_model=List[ComprehensiveExaminationViewSchema])
async def get_all(
    response: Response,
    sid: str | None = Depends(authorized_only),
    comprehensive_exams_service: ComprehensiveExaminationService = Depends(ComprehensiveExaminationService),
...
@comprehensive_exams_router.get(path=Urls.comprehensive_examination_detail.value, response_model=ComprehensiveExaminationSchema)
async def get(
    response: Response,
    exam_id: UUID4,
    sid: str | None = Depends(authorized_only),
...
@comprehensive_exams_router.post(path=Urls.comprehensive_examination_update.value, response_model=ComprehensiveExaminationSchema)
